  ...
  <div class="notes">
    ...
    <div class="form">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" v-model="note.text">
      </div>
      <div class="form-group">
        <label>Email</label>
        <input class="form-control" type="email" v-model="note.email">
      </div>
      <button class="btn btn-primary" @click="addNote" :disabled="isFilledIn">Submit</button>
    </div>
...
export default {
  ...
  computed: {
    ...
    isFilledIn() {
      if (
        this.validEmail.test(this.note.email) &&
